...
Telegram-бот для School 21: регистрация с OTP, просмотр статистики, peer review, бронирование переговорок и книг, синхронизация контента кампусов и HTTP API для интеграций.
...
- HTTP endpoint для внешней проверки регистрации

## Быстрый старт

1. Установите Go `1.26`.
