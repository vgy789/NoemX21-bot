...
Telegram-бот для School 21: регистрация с OTP, просмотр статистики, peer review, бронирование переговорок и книг, синхронизация контента кампусов и временный internal HTTP endpoint для интеграций.
...
- Временный internal HTTP endpoint для проверки регистрации
