...
type Querier interface {
	...
	EnqueueSuppressedLegacyMemberTagsByTelegram(ctx context.Context, telegramUserID int64) (int64, error)
	...
	GetBookLoanHolders(ctx context.Context, arg GetBookLoanHoldersParams) ([]string, error)
	...
	GetUserAccountIDByExternalId(ctx context.Context, arg GetUserAccountIDByExternalIdParams) (int64, error)
	...
	MarkLegacyMemberTagApplied(ctx context.Context, arg MarkLegacyMemberTagAppliedParams) error
	MarkLegacyMemberTagSkipped(ctx context.Context, arg MarkLegacyMemberTagSkippedParams) error
	MarkLegacyMemberTagSuppressed(ctx context.Context, arg MarkLegacyMemberTagSuppressedParams) error
	...
	SuppressLegacyMemberTagByLogin(ctx context.Context, arg SuppressLegacyMemberTagByLoginParams) error
	SuppressLegacyMemberTagByTelegram(ctx context.Context, arg SuppressLegacyMemberTagByTelegramParams) error
	...
	UpdateTelegramGroupWelcomeDeleteServiceMessagesByOwner(ctx context.Context, arg UpdateTelegramGroupWelcomeDeleteServiceMessagesByOwnerParams) (int64, error)
	UpdateTelegramGroupWelcomeDestinationByOwner(ctx context.Context, arg UpdateTelegramGroupWelcomeDestinationByOwnerParams) (int64, error)
	UpdateTelegramGroupWelcomeEnabledByOwner(ctx context.Context, arg UpdateTelegramGroupWelcomeEnabledByOwnerParams) (int64, error)
