...
- HTTP server для публичного endpoint
- FSM engine и action modules
- фоновые сервисы `gitsync`, `campus`, `schedule_generator`
- PostgreSQL repository layer

Отдельных runtime-контейнеров для API и worker сейчас нет: это единый процесс.
